...
public class SellerAddNewProductActivity extends AppCompatActivity {
    private String CatagoryName,Description,Price, Pname,saveCurrentDate,saveCurrentTime;
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "got the Product image Url save to Database Successfully...", Toast.LENGTH_SHORT).show();
